"""
Django settings for demo_44634 project.
...
WSGI_APPLICATION = 'demo_44634.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_44634 API",
    "DESCRIPTION": "API documentation for demo_44634 App",
    "VERSION": "v1",
}
